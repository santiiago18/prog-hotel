...
Instancia el Hotel con capacidad para 20.

Crea 4 objetos Habitacion (mezcla tipos y precios).

Registra las habitaciones en el hotel.

Intenta registrar una habitación con un número (id) que ya exista para probar la validación.

Muestra el listado completo por consola.

Busca la habitación número 105 y muestra sus detalles.
